        ...
        <div className="invoicesummary">
            <div className="invoicesummary-main mt-5">
                <div className="invoicesummary-row1">
                    <h3 style={{ color: "maroon", fontSize: "18px" }}>Sales Summary Base On Fright</h3>
                </div>
                    ...
                    <div className="invoicesummary-row2-row1">
                        <form action="">
                            ...
                            <div className="form-outer">
                                ...
                                <span className="pickup-input" style={{ width: "58%" }}>
                                    <select id="company">
                                        <option value=""></option>
                            ...
                            <span className="pickup-label" style={{ width: "10%", marginLeft: "100px" }}>
                                ...
                                <span className="pickup-label" style={{ width: "6%", marginLeft: "10px" }}>
